  ...
  if (isUser) {
    return (
      <div className="flex gap-3 justify-end max-w-3xl ml-auto animate-in fade-in slide-in-from-bottom-5 duration-300">
        <div className="bg-[#f7e99e] text-black px-4 py-3 rounded-xl shadow-sm border border-[#e8d178]">
          <p className="font-medium">{message.content}</p>
        </div>
        <div className="flex-shrink-0">
          <div className="w-8 h-8 rounded-full overflow-hidden border-2 border-[#f7e99e] shadow-sm">
            <img 
              src="/user_icon.png" 
              alt="User" 
