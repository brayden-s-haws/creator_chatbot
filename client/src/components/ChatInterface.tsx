...
export default function ChatInterface() {
  ...
  // Listen for clear chat events from ChatMessage component
  useEffect(() => {
    const clearChatHandler = () => handleClearChat();
    document.addEventListener('clearChat', clearChatHandler);
    
    return () => {
      document.removeEventListener('clearChat', clearChatHandler);
    };
  }, []);
